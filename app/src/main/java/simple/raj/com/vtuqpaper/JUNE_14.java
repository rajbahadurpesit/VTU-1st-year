...
public class JUNE_14 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_june_14);
      ...
      //  lb=(Button)findViewById(R.id.left);
        ...
        rb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), JAN_14.class);
        ...
        switch (value2) {
            ...
            case 30:
                try {
                    ss1 = getAssets().open("5thsem/DBMS/4DBMS_june(14).txt");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                loadDataFromAsset();
            ...
            case 32:
                try {
                    ss1 = getAssets().open("5thsem/CN/4CN_june(14).txt");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                loadDataFromAsset();
            ...
            case 33:
                try {
                    ss1 = getAssets().open("5thsem/SS/4SS_june(14).txt");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                loadDataFromAsset();
            ...
            case 34:
                try {
                    ss1 = getAssets().open("5thsem/OS/4OS_june(14).txt");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                loadDataFromAsset();
            ...
            case 10:
                try {
                    ss1 = getAssets().open("7thsem/PTW/4PTW_june(14).txt");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                loadDataFromAsset();
            ...
            case 11:
                try {
                    ss1 = getAssets().open("7thsem/ECS/jun14.txt");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                loadDataFromAsset();
            ...
            case 12:
                try {
                    ss1 = getAssets().open("7thsem/ACA/june14.txt");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                loadDataFromAsset();
            ...
            case 13:
                try {
                    ss1 = getAssets().open("7thsem/OOMD/4OOMD_june(14).txt");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                loadDataFromAsset();
            ...
            case 14:
                try {
                    ss1 = getAssets().open("7thsem/JAVA/jav1");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                loadDataFromAsset();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_june_14, menu);
        return true;
    }
